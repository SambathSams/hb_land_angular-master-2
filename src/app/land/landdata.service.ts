...
const baseUrl1 = 'http://localhost:8500/landdigitdata/add';
const baseUrl2 = 'http://localhost:8500/landdigitdata/get';
const baseUrl3 = 'http://localhost:8500/landdigitdata/edit';
const baseUrl4 = 'http://localhost:8500/landdigitdata/delete';
const baseUrl5 = 'http://localhost:8500/api/ForgetPassword';
const baseUrl6 = 'http://localhost:8500/api/changepassword';
const baseUrl7 = 'http://localhost:8500/landdigitdata/report1';
const baseUrl8 = 'http://localhost:8500/getfile';
const baseUrl9 = 'http://localhost:8500/update';
const baseUrl10 = 'http://localhost:8500/merge';
...
export class LanddataService {
  ...
  getDataforDivcircity(): Observable<any>  {
    ...
    return this.http.post(`http://localhost:8500/GetData`, { types: types, values:values })
    .pipe();
  }
  ...
  getCountDataforDivcircity(): Observable<any>  {
    const types = sessionStorage.getItem('type')! ;
    const values = sessionStorage.getItem('value')!;
    return this.http.get(`http://localhost:8500/GetDataCount`, { params: { types: types, values:values } })
    .pipe();
  }
  ...
  verifyotp(username : any, otp : any) {
    return this.http.post<any>('http://localhost:8500/api/VerifyOtp', { username, otp }).pipe(
      map(otpData => {
